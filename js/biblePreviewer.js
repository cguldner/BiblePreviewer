...
const bibleBooks = {
    ...
    'Acts?': 'Acts',
    'Ro(?:m(?:ans)?)?': 'Rom',
    [firstPrefix + 'Co(?:r(?:inthians)?)?']: '1Cor',
    [secondPrefix + 'Co(?:r(?:inthians)?)?']: '2Cor',
    'Gal(?:atians)?': 'Gal',
    'Eph(?:es(?:ians)?)?': 'Eph',
    'Phil(?:ippians)?': 'Phil',
    'Col(?:ossians)?': 'Col',
